...
///     and it should have the given minimum <see cref="string.Length"/>.
/// </summary>
/// <seealso cref="OptionalStringMinLengthConstraintBase"/>
public abstract class NotNullStringMinLengthConstraintBase : SimpleTypedMemberConstraintBase<string>
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="NotNullStringMinLengthConstraintBase"/> class.
    /// </summary>
    /// <param name="minLength">
    ///     The minimum allowed length of a <see cref="string"/> value.
    /// </param>
    protected NotNullStringMinLengthConstraintBase(int minLength)
    ...
    protected override ValidationErrorDetails CreateValidationErrorDetails(MemberConstraintValidationContext memberContext, string? value)
    {
        ...
        return AsInvariant($"The string value must not be null, and its length must be at least {MinLength}.{actualValueDetails}");
    }
}