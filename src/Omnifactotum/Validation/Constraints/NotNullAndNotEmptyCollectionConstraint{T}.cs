...
///     or the <see cref="ICollection{T}"/> type (or compatible) should not be <see langword="null"/> and should not be empty.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class NotNullAndNotEmptyCollectionConstraint<T> : TypedMemberConstraintBase<IEnumerable<T>?>
{
    /// <inheritdoc />
