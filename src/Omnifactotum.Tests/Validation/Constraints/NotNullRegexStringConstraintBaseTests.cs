...
internal sealed class NotNullRegexStringConstraintBaseTests : TypedConstraintTestsBase<NotNullRegexStringConstraintBaseTests.RegexStringConstraint, string?>
{
    protected override void OnTestConstruction(RegexStringConstraint testee)
    {
        base.OnTestConstruction(testee);

        Assert.That(() => NotNullRegexStringConstraintBase.DefaultRegexTimeout, Is.Not.EqualTo(Regex.InfiniteMatchTimeout));
    ...
    internal sealed class RegexStringConstraint : NotNullRegexStringConstraintBase
    {
