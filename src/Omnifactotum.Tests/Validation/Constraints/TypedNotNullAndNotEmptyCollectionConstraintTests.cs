...
internal sealed class TypedNotNullAndNotEmptyCollectionConstraintTests
    : TypedConstraintTestsBase<NotNullAndNotEmptyCollectionConstraint<int>, IEnumerable<int>?>
{
