...
[TestFixture(TestOf = typeof(NotNullWebUrlConstraint))]
internal sealed class NotNullWebUrlConstraintTests : TypedConstraintTestsBase<NotNullWebUrlConstraint, string?>
{
