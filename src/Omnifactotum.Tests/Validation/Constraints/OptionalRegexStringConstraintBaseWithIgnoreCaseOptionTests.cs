...
internal sealed partial class OptionalRegexStringConstraintBaseWithIgnoreCaseOptionTests
    : TypedConstraintTestsBase<OptionalRegexStringConstraintBaseWithIgnoreCaseOptionTests.RegexStringConstraint, string?>
{
    ...
    protected override ValidationErrorDetails GetTypedInvalidValueErrorDetails(string? invalidValue)
        => new(
            $"[{invalidValue}] does not start with 'Foo' (ignoring case).",
            $"The value \"{
                invalidValue}\" does not match the regular expression pattern \"^Foo\" (options: IgnoreCase, ExplicitCapture, Compiled, Singleline).");

    internal sealed partial class RegexStringConstraint : OptionalRegexStringConstraintBase
    {
        ...
        public const int TimeoutValueMilliseconds = 73;
        ...
        protected override string GetErrorDetailsText(string? value) => $"[{value}] does not start with 'Foo' (ignoring case).";
