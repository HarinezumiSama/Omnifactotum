...
{
    internal abstract class SyncValueContainerForValueTypeTestsBase<TValue> : SyncValueContainerTestsBase<TValue>
        where TValue : struct, IEquatable<TValue>
    {
        private readonly ImmutableArray<TValue?> _allValues;

        protected SyncValueContainerForValueTypeTestsBase(TValue value, TValue anotherValue)
